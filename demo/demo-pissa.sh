...
proj_dir='/home/rwkv/JL/out_model/meta_pissa_mask'
...
--my_testing "x060" \
--lora --lora_r $lora_r --lora_alpha 128 --lora_dropout 0.01 --lora_parts=att,ffn,time,ln \
--PISSA --svd_niter $svd_niter \
--dataload pad --wandb finetune --loss_mask pad
