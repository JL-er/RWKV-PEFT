...
"""
    ...
    acc, stragegy = get_accerator_and_strategy(args)
    
    if pl.__version__[0] == '2':
        trainer = Trainer(accelerator=acc, strategy=stragegy, devices=args.devices, num_nodes=args.num_nodes, precision=args.precision,
